...
@section('icerik')
    ...
    <div class="content">
        ...
        <div class="page-title pt30 pb30">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4  class="mb0">Hazır Hareket Planı Oluştur</h4>
                    <div align="right">
        ...
        <div id="tekrarlar">
                    <form id="form" data-parsley-validate class="form-horizontal form-label-left" action="/hazir/egzersizplan" method="get">
                        ...
                        <form id="form" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" method="POST" action="{{url('/hazir/egzersizplan_session')}}"  >
                ...
                <div id="hazir_plan_imi">
                            <div class="ui-widget">
                                ...
                                <input type="text" @if(isset($id['plan_ismi'])) value="{{$id['plan_ismi']}}" @endif required name="combobox">
