        ...
        <div class="page-title pt30 pb30">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div id="tekrarlar">
                    <form id="form" data-parsley-validate class="form-horizontal form-label-left" action={{url('/hasta_liste/plan/guncelle/'.$set_sirasi.'/'.$hasta_id)}} method="get">
                        ...
                        <div  id="tum-hareketler">
                            ...
                            <button style="font-size: 11px" type="submit" class="btn btn-danger btn-xs">Tüm Hareketlere Uygula *</button>
                        </div>
                ...
                @if(isset($hastalar))
                        <form id="form" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" method="get" action="{{url('/egzersizplan_session/'.$set_sirasi.'/'.$hasta_id)}}"  >
                            ...
                            <div id="baslangıc_tarihi" >
                                ...
                                <br>
                                <input type="date" @if(isset($set_bilgileri)) value="{{$set_bilgileri->baslangic_tarihi}}" @endif name="baslangic_tarihi">
                            </div>

                            <div id="bitis_tarihi">
                                <label for="">Program Bitiş Tarihi:</label>
                                <br>
                                <input type="date" name="bitis_tarihi" @if(isset($set_bilgileri)) value="{{$set_bilgileri->bitis_tarihi}}" @endif>
                            </div>

                            <div id="program_adı">
                                <label for="">Program Adı:</label>
                                <br>
                                <input type="text" name="program_adi" @if(isset($set_bilgileri)) value="{{$set_bilgileri->program_adi}}" @endif>
                            </div>
                            ...
                            <div class="ui-widget">
                                <label>Hasta İsmi Seciniz: </label>
                                <select id="combobox" name="combobox">
                                    <option value="">Hasta İsimleri...</option>
                                    @foreach($hastalar as $hasta)
                                        <option @if(isset($hasta_id)) @if($hasta_id==$hasta->id) selected @endif @endif value="{{$hasta->id}}"><?php echo $hasta->hasta_ad."  ".$hasta->hasta_soyad;?></option>
                                    @endforeach
                                </select>
                            </div>
                            </div>
                                                                    ...
                                                                    <div id="gunler" class="container left">
                                                                        <div class="row input-group">
                                                                            ...
                                                                            <select name="gunluk_tekrar-{{$i}}">
                                                                                <option value="">Seçiniz</option>
                                                                                <option  @if(isset($gunluk_tekrar))@if($gunluk_tekrar=="Günde 1") selected @endif @else  @if($olan_hareket!=null) @if($olan_hareket->gunluk_tekrar=="Günde 1") selected @endif @endif @endif value="Günde 1">Günde 1</option>
