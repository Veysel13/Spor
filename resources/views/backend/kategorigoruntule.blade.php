        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Hastalık Kategori Güncelle</h3>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="form" data-parsley-validate class="form-horizontal form-label-left"  method="POST" action="{{url('/hastalikkategoriliste/guncelle')}}"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select size="8" class="form-control"  name="kategori_ust">


                                                    {!!  kategoriguncelle($kategori->kategori_ust) !!}
