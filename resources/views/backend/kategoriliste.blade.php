        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Hastalık Kategori Listesi<small></small></h3>
                </div>




                <form  method="" action="{{url('/hastalikkategori')}}">
                ...
                <form action="{{url('/hastalikkategoriliste')}}" method="get" >
                                ...
                                @if(isset($_GET['arama']))
                                    ...
                                    @foreach($kategoriarama as $arama)
                                        ...
                                        <tr>
                                            ...
                                            $id=App\Kategoriler::find($kategori_id);
                                            ?>
                                                <td>{{$say}}</td>
                                                ...
                                                <div style="display:none">
                                                    <form action="{{url('/hastalikkategoriliste/sil')}}" method="POST" id="silme_form">
                                                        {{csrf_field()}}
                                                        <input id="silinecek_id" name="id">
                                                    </form>
                                                </div>
                                                <td><input onclick="sil(this,'{{$arama->id}}')"  type="button" class="btn btn-danger" value="sil"></td>
                                                <td><a href="{{url('/hastalikkategoriliste/guncelle/'.$arama->id)}}" class="btn btn-primary">Görüntüle</a></td>
                                ...
                                @else
                                    ...
                                    @foreach($kategoriler as $kategori)
                                        <tr>
                                          ...
                                          <!--  <td><a href="{{url('/hastalikkategoriliste/sil/'.$kategori->id)}}" class="btn btn-danger">Sil</a></td>-->
                                                <div style="display:none">
                                                    <form action="{{url('/hastalikkategoriliste/sil')}}" method="POST" id="silme_form">
                                                        {{csrf_field()}}
                                                        <input id="silinecek_id" name="id">
                                                ...
                                                <td><a href="{{url('/hastalikkategoriliste/guncelle/'.$kategori->id)}}" class="btn btn-primary">Görüntüle</a></td>
