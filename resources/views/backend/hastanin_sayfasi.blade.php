...
@section('icerik')
    ...
    <div class="content">
        ...
        <form action="{{url('/hasta_plan_kayit/goruntule')}}"  method="post">
            ...
            <div id="formmusteri" class="container">
                ...
                <input type="text" id="lname" value="{{$hasta->hasta_telefon}}" name="hasta_telefon" placeholder="Telefon..">
            ...
            <div id="tabmenu1" class="card">
                <div>
                    ...
                    <ul class="nav tabs-admin" role="tablist">
                        ...
                        <li role="presentation" class=" nav-item"><a class="nav-link" href="#t3" aria-controls="t3" role="tab" data-toggle="tab">Plan Çizelgesi</a></li>
                    </ul>
                                        ...
                                        @if(isset($hasta_id))
                                            ...
                                            <div id="musteri_plan"  style="height: 500px; overflow-x: hidden; overflow-y: scroll;">
                                                ...
                                                <table id="data-table"  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <?php
                                                    {//$hasta_ad=auth()->user()->name;
                                                        $hasta=\App\Hastalar::where('id',$hasta_id)->first();
                                                        $planlar=\App\Setler::where('hasta_id',$hasta->id)->get()->groupBy('plan_sayisi');
